...
void menu_filter(
    menu_t *self, char *search);

void menu_recalculate_dims(
    menu_t *self, struct winsize winsz);

void menu_render(
    menu_t *self, struct winsize winsz);

void menu_fast_render(
    menu_t *self, int old_selected_index, struct winsize winsz);
    
void menu_handle_key(menu_t *self, char ch);

mitem_t *menu_get_selected_item();

unsigned short menu_get_selected_index(
    menu_t *self);

unsigned short menu_get_delta(
    menu_t *self);
